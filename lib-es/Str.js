    ...
    if (e) {
        switch (e.statusCode) {
            ...
            case SW_HASH_SIGNING_MODE_NOT_ENABLED:
                return new StellarHashSigningNotEnabledError("Please enable Hash signing in the Stellar app Settings", undefined, { cause: e });
            case SW_DATA_TOO_LARGE:
                return new StellarDataTooLargeError("The data length is incorrect, is it too long?", undefined, { cause: e });
        }
    }
    return e;
};
