...
class Str {
    ...
    signSorobanAuthorization(path, hashIdPreimage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.sendToDevice(INS_SIGN_SOROBAN_AUTHORATION, payload);
            return { signature: resp };
        });
    }
    /**
    ...
    if (e) {
        switch (e.statusCode) {
            ...
            case SW_HASH_SIGNING_MODE_NOT_ENABLED:
                return new errors_1.StellarHashSigningNotEnabledError("Please enable Hash signing in the Stellar app Settings", undefined, { cause: e });
            case SW_DATA_TOO_LARGE:
                return new errors_1.StellarDataTooLargeError("The data length is incorrect, is it too long?", undefined, { cause: e });
        }
    }
    return e;
};
